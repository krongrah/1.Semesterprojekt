...
public class World implements Serializable {
    ...
    private void createWorld() {
        ...
        Beverage whiskey = new Beverage("Whiskey", "This bottle is your favorite drink, and the reason you love coming home.", 8, 5);
        Beverage gin = new Beverage("Half-empty Gin", "its a half-empty bottle of gin, some idiot wasted his drink", 4, 7);
        Beverage beerKeg = new Beverage("Keg Of beer", "Its a keg of beer, nobody will notice if you take this", 16, 5);
        ...
        Beverage beer = new Beverage("Beer", "It's a well known brand called pisswasser", 2, 5);
