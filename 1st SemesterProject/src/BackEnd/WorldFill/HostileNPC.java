...
public class HostileNPC extends NPC implements Serializable {
     ...
     * @param aggression The chance of getting jumped, when you enter a room. 0=
     * not possible, 0.5= 50% chance, 1 = always
     */
     ...
     * @param clue the clue given in dialog [If any]
     * @param clueRelease How many times the player has to talk to the NPC
     * before getting a clue. health Health of the Hostile NPC, used for
     * fighting. Standard= 50 damage The damage the NPC can deal to the player.
     * Standard is 7 aggression The chance of getting jumped, when you enter a
     * room. 0= not possible, 0.5= 50% chance, 1 = always. Standard is 0.
     */
